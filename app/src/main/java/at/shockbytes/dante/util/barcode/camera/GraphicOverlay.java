...
public class GraphicOverlay<T extends GraphicOverlay.Graphic> extends View {
    ...
    public interface OnGraphicAvailableListener<T> {

        void onFirstGraphicAvailable(T graphic);
    }

    private OnGraphicAvailableListener<T> onGraphicAvailableListener;
    ...
    public void add(T graphic) {
        synchronized (mLock) {
            ...
            if (mFirstGraphic == null) {
                if (onGraphicAvailableListener != null) {
    ...
    public void setOnGraphicAvailableListener(OnGraphicAvailableListener<T> listener) {
        this.onGraphicAvailableListener = listener;
    }

    public void removeGraphicListener() {
