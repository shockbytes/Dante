...
public class DownloadBookFragment extends BaseFragment
    ...
    @BindViews({ R.id.fragment_download_book_btn_upcoming,
            R.id.fragment_download_book_btn_current,
            R.id.fragment_download_book_btn_done,
            R.id.fragment_download_book_btn_not_my_book})
    List<View> animViews;

    @BindView(R.id.fragment_download_book_imgview_cover)
    protected ImageView imgViewCover;

    @BindView(R.id.fragment_download_book_txt_title)
    protected TextView txtTitle;

    @BindView(R.id.fragment_download_book_rv_other_suggestions)
    protected RecyclerView rvOtherSuggestions;

    @BindView(R.id.fragment_download_book_txt_other_suggestions)
    protected TextView txtOtherSuggestions;

    @BindView(R.id.fragment_download_book_btn_not_my_book)
    protected Button btnNotMyBook;

    @BindView(R.id.fragment_download_book_progressbar)
    protected ProgressBar progressBar;

    @BindView(R.id.fragment_download_book_main_view)
    protected View mainView;

    @BindView(R.id.fragment_download_book_error_view)
    protected View errorView;

    @BindView(R.id.fragment_download_book_txt_error_cause)
    ...
    private void downloadBook() {
        ...
        bookManager.downloadBook(query).subscribe(new Consumer<BookSuggestion>() {
            @Override
            public void accept(final BookSuggestion suggestion) {
