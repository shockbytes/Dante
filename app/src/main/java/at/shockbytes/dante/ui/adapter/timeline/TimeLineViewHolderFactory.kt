...
class TimeLineViewHolderFactory(
    ...
    override fun create(parent: ViewGroup, viewType: Int): BaseAdapter.ViewHolder<TimeLineItem> {
        return when (viewType) {
            R.layout.item_time_line_book -> BookTimeLineViewHolder(inflater.inflate(viewType, parent, false), imageLoader)
            R.layout.item_time_line_header -> MonthHeaderViewHolder(inflater.inflate(viewType, parent, false))
